...
class CheckModalAvailability extends React.Component {
    ...
    checkAvailability = ( e ) => {
        ...
        // Sending timings to deskBooking component
        const fromTime = this.state.fromTime.format( "YYYY-MM-DD HH:mm:ss" ),
                toTime = this.state.toTime.format( "YYYY-MM-DD HH:mm:ss" );

                this.props.saveTimings( fromTime, toTime );
    ...
    render(){
        return(
            <Modal isOpen={ this.props.isOpen } toggle={ this.props.toggle } className = "modal-dialog" size="lg">
